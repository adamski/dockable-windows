...
MainContentComponent::MainContentComponent()
{
	...
	addAndMakeVisible(arrangeableDock);
    ...
    arrangeableDock.addComponentToNewRow(new ExampleDockableComponent("Extra View", baseColour.withRotatedHue(0.9f)), 0);
    arrangeableDock.addComponentToDock(new ExampleDockableComponent("Another View", baseColour.withRotatedHue(0.85f)));
    arrangeableDock.addComponentToNewRow(new ExampleDockableComponent("Top", baseColour.withRotatedHue(0.85f)), 0);
    arrangeableDock.addComponentToNewRow(new ExampleDockableComponent("Bottom", baseColour.withRotatedHue(0.85f)), -1);
}
...
void MainContentComponent::resized()
{
	...
	arrangeableDock.setBounds(area.reduced(4));
}